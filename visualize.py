...
def plot_stats(statistics, ylog=False, view=False, filename=NEAT_DIR + '/avg_fitness.svg'):
...
def plot_species(statistics, view=False, filename=NEAT_DIR + '/speciation.svg'):
